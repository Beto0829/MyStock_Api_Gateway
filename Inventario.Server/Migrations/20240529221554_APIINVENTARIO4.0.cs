...
{
    /// <inheritdoc />
    public partial class APIINVENTARIO40 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 3, 0m, 607500m, 607500m },
                    { 2, 1, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 1, 1500m, 28500m, 30000m },
                    { 3, 4, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 5, 2400m, 186400m, 188800m },
                    { 4, 1, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 1, 0m, 132300m, 132300m },
                    { 5, 1, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 11, 0m, 4500m, 4500m },
                    { 6, 1, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 3, 16000m, 144000m, 160000m },
                    { 7, 6, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 7, 0m, 46052000m, 46052000m },
                    { 8, 2, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 5, 3200000m, 28800000m, 32000000m },
                    { 9, 1, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 2, 0m, 9000m, 9000m },
                    { 10, 2, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 13, 0m, 52400000m, 52400000m },
                    { 11, 2, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 13, 74998m, 1424970m, 1499968m },
                    { 12, 2, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 9, 0m, 27253500m, 27253500m },
                    { 13, 2, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 2, 0m, 5690000m, 5690000m },
                    { 14, 1, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 7, 2309998m, 13089988m, 15399986m },
                    { 15, 1, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 2, 1275000m, 24225000m, 25500000m },
                    { 16, 1, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 4, 1275000m, 24225000m, 25500000m },
                    { 17, 1, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 16, 0m, 9000m, 9000m },
                    { 18, 1, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 8, 0m, 3900000m, 3900000m },
                    { 19, 1, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 3, 0m, 3900000m, 3900000m },
                    { 20, 6, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 10, 0m, 46052000m, 46052000m },
                    { 21, 1, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 10, 0m, 4500m, 4500m },
                    { 22, 2, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 5, 74998m, 1424970m, 1499968m },
                    { 23, 2, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 16, 0m, 32400000m, 32400000m },
                    { 24, 1, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 3, 0m, 9000m, 9000m },
                    { 25, 2, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 12, 0m, 32400000m, 32400000m },
                    { 26, 1, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 11, 0m, 14000000m, 14000000m },
                    { 27, 2, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 13, 0m, 125900000m, 125900000m },
                    { 28, 1, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 9, 1275000m, 24225000m, 25500000m },
                    { 29, 2, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 14, 0m, 97700000m, 97700000m },
                    { 30, 1, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 11, 92000m, 1748000m, 1840000m },
                    { 31, 3, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 4, 0m, 71100000m, 71100000m },
                    { 32, 2, new DateTime(2024, 8, 13, 3, 0, 0, 0, DateTimeKind.Unspecified), 6, 0m, 97700000m, 97700000m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Activo", 1, 50, new DateTime(2024, 4, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), 6, 11, 5, "", 900m, 1500m },
                    { 2, "Activo", 15, 115, new DateTime(2024, 2, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), 8, 20, 7, "", 3500m, 6000m },
                    { 3, "Activo", 20, 27, new DateTime(2024, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 10, 23, 9, "", 10000m, 18900m },
                    { 4, "Activo", 18, 18, new DateTime(2024, 3, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), 10, 26, 9, "", 6000m, 12000m },
                    { 5, "Activo", 10, 15, new DateTime(2024, 3, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), 11, 29, 10, "", 2300m, 3000m },
                    { 6, "Activo", 33, 33, new DateTime(2024, 3, 9, 0, 0, 0, 0, DateTimeKind.Unspecified), 12, 31, 11, "", 1200m, 3000m },
                    { 7, "Activo", 10, 45, new DateTime(2024, 2, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), 12, 34, 11, "", 5000m, 8000m },
                    { 8, "Activo", 10, 20, new DateTime(2024, 4, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), 12, 35, 11, "", 2500m, 3400m },
                    { 9, "Activo", 22, 25, new DateTime(2024, 2, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), 13, 42, 12, "", 2000m, 3800m },
                    { 10, "Activo", 22, 31, new DateTime(2024, 1, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), 14, 40, 13, "", 1300m, 2600m },
                    { 11, "Activo", 12, 12, new DateTime(2024, 2, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), 15, 45, 14, "", 4000m, 6300m },
                    { 12, "Activo", 59, 135, new DateTime(2024, 1, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), 15, 44, 14, "", 4500m, 10000m },
                    { 13, "Activo", 1, 80, new DateTime(2024, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 16, 47, 15, "", 18000m, 34999m },
                    { 14, "Activo", 23, 50, new DateTime(2024, 2, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), 16, 48, 15, "", 790000m, 990000m },
                    { 15, "Activo", 13, 20, new DateTime(2024, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), 16, 49, 15, "", 45000m, 60000m },
                    { 16, "Activo", 4, 35, new DateTime(2024, 4, 27, 0, 0, 0, 0, DateTimeKind.Unspecified), 16, 50, 15, "", 100000m, 170000m },
                    { 17, "Activo", 36, 100, new DateTime(2024, 2, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), 16, 53, 15, "", 1700000m, 1980000m },
                    { 18, "Activo", 13, 13, new DateTime(2024, 3, 13, 0, 0, 0, 0, DateTimeKind.Unspecified), 16, 55, 15, "", 178000m, 222000m },
                    { 19, "Activo", 10, 10, new DateTime(2024, 5, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 17, 59, 16, "", 60000m, 99000m },
                    { 20, "Activo", 26, 40, new DateTime(2024, 4, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), 17, 61, 16, "", 800000m, 1099999m },
                    { 21, "Activo", 15, 38, new DateTime(2024, 1, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 18, 63, 17, "", 46000m, 80000m },
                    { 22, "Activo", 30, 30, new DateTime(2024, 2, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), 19, 66, 18, "", 400000m, 470000m },
                    { 23, "Activo", 15, 15, new DateTime(2024, 3, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), 19, 67, 18, "", 20000m, 32000m },
                    { 24, "Activo", 20, 20, new DateTime(2024, 1, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), 20, 73, 19, "", 267000m, 450000m },
                    { 25, "Activo", 0, 105, new DateTime(2024, 1, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), 21, 75, 20, "", 800000m, 1100000m },
                    { 26, "Activo", 11, 11, new DateTime(2024, 3, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), 21, 77, 20, "", 125000m, 230000m },
                    { 27, "Activo", 10, 70, new DateTime(2024, 3, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), 21, 78, 20, "", 70000m, 130000m },
                    { 28, "Activo", 42, 42, new DateTime(2024, 5, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), 22, 80, 21, "", 90000m, 136000m },
                    { 29, "Activo", 22, 22, new DateTime(2024, 4, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), 23, 81, 22, "", 1800000m, 2780000m },
                    { 30, "Activo", 1, 70, new DateTime(2024, 5, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), 24, 84, 23, "", 270000m, 400000m },
                    { 31, "Activo", 2, 50, new DateTime(2024, 4, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), 25, 87, 24, "", 2000000m, 2800000m },
                    { 32, "Activo", 5, 16, new DateTime(2024, 4, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), 25, 88, 24, "", 2300000m, 2900000m },
                    { 33, "Activo", 0, 35, new DateTime(2024, 4, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), 25, 89, 24, "", 800000m, 1400000m },
                    { 34, "Activo", 4, 27, new DateTime(2024, 2, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), 25, 85, 24, "", 2400000m, 3800000m },
                    { 35, "Activo", 1, 21, new DateTime(2024, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), 5, 5, 4, "", 1800m, 3500m }
                });
