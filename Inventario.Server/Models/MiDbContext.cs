...
namespace Inventarios.Server.Models
{
    public class MiDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 1, IdCategoria = 6, IdProducto = 11, IdProveedor = 5, PrecioCompra = 900, PrecioVenta = 1500, ExistenciaInicial = 50, ExistenciaActual = 50, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 2, IdCategoria = 8, IdProducto = 20, IdProveedor = 7, PrecioCompra = 3500, PrecioVenta = 6000, ExistenciaInicial = 150, ExistenciaActual = 150, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 3, IdCategoria = 10, IdProducto = 23, IdProveedor = 9, PrecioCompra = 10000, PrecioVenta = 18900, ExistenciaInicial = 50, ExistenciaActual = 50, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            ...
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 5, IdCategoria = 11, IdProducto = 29, IdProveedor = 10, PrecioCompra = 2300, PrecioVenta = 3000, ExistenciaInicial = 50, ExistenciaActual = 50, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            ...
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 7, IdCategoria = 12, IdProducto = 34, IdProveedor = 11, PrecioCompra = 5000, PrecioVenta = 8000, ExistenciaInicial = 100, ExistenciaActual = 100, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 8, IdCategoria = 12, IdProducto = 35, IdProveedor = 11, PrecioCompra = 2500, PrecioVenta = 3400, ExistenciaInicial = 300, ExistenciaActual = 300, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 9, IdCategoria = 13, IdProducto = 42, IdProveedor = 12, PrecioCompra = 2000, PrecioVenta = 3800, ExistenciaInicial = 70, ExistenciaActual = 70, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 10, IdCategoria = 14, IdProducto = 40, IdProveedor = 13, PrecioCompra = 1300, PrecioVenta = 2600, ExistenciaInicial = 90, ExistenciaActual = 90, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            ...
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 30, IdCategoria = 24, IdProducto = 84, IdProveedor = 23, PrecioCompra = 270000, PrecioVenta = 400000, ExistenciaInicial = 70, ExistenciaActual = 70, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 31, IdCategoria = 25, IdProducto = 87, IdProveedor = 24, PrecioCompra = 2000000, PrecioVenta = 2800000, ExistenciaInicial = 50, ExistenciaActual = 50, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 32, IdCategoria = 25, IdProducto = 88, IdProveedor = 24, PrecioCompra = 2300000, PrecioVenta = 2900000, ExistenciaInicial = 70, ExistenciaActual = 70, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 33, IdCategoria = 25, IdProducto = 89, IdProveedor = 24, PrecioCompra = 800000, PrecioVenta = 1400000, ExistenciaInicial = 200, ExistenciaActual = 200, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 34, IdCategoria = 25, IdProducto = 85, IdProveedor = 24, PrecioCompra = 2400000, PrecioVenta = 3800000, ExistenciaInicial = 50, ExistenciaActual = 50, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
