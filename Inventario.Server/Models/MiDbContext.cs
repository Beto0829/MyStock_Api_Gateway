...
namespace Inventarios.Server.Models
{
    public class MiDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 1, IdCategoria = 6, IdProducto = 11, IdProveedor = 5, PrecioCompra = 900, PrecioVenta = 1500, ExistenciaInicial = 50, ExistenciaActual = 1, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 2, IdCategoria = 8, IdProducto = 20, IdProveedor = 7, PrecioCompra = 3500, PrecioVenta = 6000, ExistenciaInicial = 115, ExistenciaActual = 15, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 3, IdCategoria = 10, IdProducto = 23, IdProveedor = 9, PrecioCompra = 10000, PrecioVenta = 18900, ExistenciaInicial = 27, ExistenciaActual = 20, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 4, IdCategoria = 10, IdProducto = 26, IdProveedor = 9, PrecioCompra = 6000, PrecioVenta = 12000, ExistenciaInicial = 18, ExistenciaActual = 18, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 5, IdCategoria = 11, IdProducto = 29, IdProveedor = 10, PrecioCompra = 2300, PrecioVenta = 3000, ExistenciaInicial = 15, ExistenciaActual = 10, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 6, IdCategoria = 12, IdProducto = 31, IdProveedor = 11, PrecioCompra = 1200, PrecioVenta = 3000, ExistenciaInicial = 33, ExistenciaActual = 33, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 7, IdCategoria = 12, IdProducto = 34, IdProveedor = 11, PrecioCompra = 5000, PrecioVenta = 8000, ExistenciaInicial = 45, ExistenciaActual = 10, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 8, IdCategoria = 12, IdProducto = 35, IdProveedor = 11, PrecioCompra = 2500, PrecioVenta = 3400, ExistenciaInicial = 20, ExistenciaActual = 10, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 9, IdCategoria = 13, IdProducto = 42, IdProveedor = 12, PrecioCompra = 2000, PrecioVenta = 3800, ExistenciaInicial = 25, ExistenciaActual = 22, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 10, IdCategoria = 14, IdProducto = 40, IdProveedor = 13, PrecioCompra = 1300, PrecioVenta = 2600, ExistenciaInicial = 31, ExistenciaActual = 22, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 11, IdCategoria = 15, IdProducto = 45, IdProveedor = 14, PrecioCompra = 4000, PrecioVenta = 6300, ExistenciaInicial = 12, ExistenciaActual = 12, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 12, IdCategoria = 15, IdProducto = 44, IdProveedor = 14, PrecioCompra = 4500, PrecioVenta = 10000, ExistenciaInicial = 135, ExistenciaActual = 59, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 13, IdCategoria = 16, IdProducto = 47, IdProveedor = 15, PrecioCompra = 18000, PrecioVenta = 34999, ExistenciaInicial = 80, ExistenciaActual = 1, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 14, IdCategoria = 16, IdProducto = 48, IdProveedor = 15, PrecioCompra = 790000, PrecioVenta = 990000, ExistenciaInicial = 50, ExistenciaActual = 23, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 15, IdCategoria = 16, IdProducto = 49, IdProveedor = 15, PrecioCompra = 45000, PrecioVenta = 60000, ExistenciaInicial = 20, ExistenciaActual = 13, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 16, IdCategoria = 16, IdProducto = 50, IdProveedor = 15, PrecioCompra = 100000, PrecioVenta = 170000, ExistenciaInicial = 35, ExistenciaActual = 4, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 17, IdCategoria = 16, IdProducto = 53, IdProveedor = 15, PrecioCompra = 1700000, PrecioVenta = 1980000, ExistenciaInicial = 100, ExistenciaActual = 36, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 18, IdCategoria = 16, IdProducto = 55, IdProveedor = 15, PrecioCompra = 178000, PrecioVenta = 222000, ExistenciaInicial = 13, ExistenciaActual = 13, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 19, IdCategoria = 17, IdProducto = 59, IdProveedor = 16, PrecioCompra = 60000, PrecioVenta = 99000, ExistenciaInicial = 10, ExistenciaActual = 10, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 20, IdCategoria = 17, IdProducto = 61, IdProveedor = 16, PrecioCompra = 800000, PrecioVenta = 1099999, ExistenciaInicial = 40, ExistenciaActual = 26, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 21, IdCategoria = 18, IdProducto = 63, IdProveedor = 17, PrecioCompra = 46000, PrecioVenta = 80000, ExistenciaInicial = 38, ExistenciaActual = 15, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            ...
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 29, IdCategoria = 23, IdProducto = 81, IdProveedor = 22, PrecioCompra = 1800000, PrecioVenta = 2280000, ExistenciaInicial = 22, ExistenciaActual = 22, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            ...
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 31, IdCategoria = 25, IdProducto = 87, IdProveedor = 24, PrecioCompra = 2000000, PrecioVenta = 2400000, ExistenciaInicial = 50, ExistenciaActual = 2, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            ...
            modelBuilder.Entity<Entrada>().HasData(new Entrada { Id = 34, IdCategoria = 25, IdProducto = 85, IdProveedor = 24, PrecioCompra = 2400000, PrecioVenta = 3100000, ExistenciaInicial = 27, ExistenciaActual = 4, Nota = "", FechaEntrada = RandomDate(new DateTime(2024, 1, 1), new DateTime(2024, 5, 12)), Estado = "Activo" });
            ...
            //NEW
            modelBuilder.Entity<Salida>().HasData(new Salida { Id = 11, FechaFactura = fechaAleatoria, IdCliente = 13, CantidadProductos = 2, TotalPagarConDescuento = 1424970, TotalPagarSinDescuento = 1499968, TotalDescuento = 74998 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 22, IdSalida = 11, IdCategoria = 15, IdProducto = 44, IdEntrada = 12, Precio = 10000, Cantidad = 38, Descuento = 5, ValorDescuento = 19000, Total = 361000 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 23, IdSalida = 11, IdCategoria = 16, IdProducto = 47, IdEntrada = 13, Precio = 34999, Cantidad = 32, Descuento = 5, ValorDescuento = 55998, Total = 1063970 });

            modelBuilder.Entity<Salida>().HasData(new Salida { Id = 12, FechaFactura = fechaAleatoria, IdCliente = 9, CantidadProductos = 2, TotalPagarConDescuento = 27253500, TotalPagarSinDescuento = 27253500, TotalDescuento = 0 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 24, IdSalida = 12, IdCategoria = 16, IdProducto = 47, IdEntrada = 13, Precio = 34999, Cantidad = 15, Descuento = 0, ValorDescuento = 0, Total = 523500 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 25, IdSalida = 12, IdCategoria = 16, IdProducto = 48, IdEntrada = 14, Precio = 990000, Cantidad = 27, Descuento = 0, ValorDescuento = 0, Total = 26730000 });

            modelBuilder.Entity<Salida>().HasData(new Salida { Id = 13, FechaFactura = fechaAleatoria, IdCliente = 2, CantidadProductos = 2, TotalPagarConDescuento = 5690000, TotalPagarSinDescuento = 5690000, TotalDescuento = 0 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 26, IdSalida = 13, IdCategoria = 16, IdProducto = 49, IdEntrada = 15, Precio = 60000, Cantidad = 7, Descuento = 0, ValorDescuento = 0, Total = 420000 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 27, IdSalida = 13, IdCategoria = 16, IdProducto = 50, IdEntrada = 16, Precio = 170000, Cantidad = 31, Descuento = 0, ValorDescuento = 0, Total = 5270000 });

            modelBuilder.Entity<Salida>().HasData(new Salida { Id = 14, FechaFactura = fechaAleatoria, IdCliente = 7, CantidadProductos = 1, TotalPagarConDescuento = 13089988, TotalPagarSinDescuento = 15399986, TotalDescuento = 2309998 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 28, IdSalida = 14, IdCategoria = 17, IdProducto = 61, IdEntrada = 20, Precio = 1099999, Cantidad = 14, Descuento = 15, ValorDescuento = 2309998, Total = 13089988 });

            modelBuilder.Entity<Salida>().HasData(new Salida { Id = 15, FechaFactura = fechaAleatoria, IdCliente = 2, CantidadProductos = 1, TotalPagarConDescuento = 24225000, TotalPagarSinDescuento = 25500000, TotalDescuento = 1275000 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 29, IdSalida = 15, IdCategoria = 21, IdProducto = 75, IdEntrada = 25, Precio = 1700000, Cantidad = 15, Descuento = 5, ValorDescuento = 1275000, Total = 24225000 });

            modelBuilder.Entity<Salida>().HasData(new Salida { Id = 16, FechaFactura = fechaAleatoria, IdCliente = 4, CantidadProductos = 1, TotalPagarConDescuento = 24225000, TotalPagarSinDescuento = 25500000, TotalDescuento = 1275000 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 30, IdSalida = 16, IdCategoria = 21, IdProducto = 75, IdEntrada = 25, Precio = 1700000, Cantidad = 15, Descuento = 5, ValorDescuento = 1275000, Total = 24225000 });

            modelBuilder.Entity<Salida>().HasData(new Salida { Id = 17, FechaFactura = fechaAleatoria, IdCliente = 16, CantidadProductos = 1, TotalPagarConDescuento = 9000, TotalPagarSinDescuento = 9000, TotalDescuento = 0 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 31, IdSalida = 9, IdCategoria = 6, IdProducto = 11, IdEntrada = 1, Precio = 1500, Cantidad = 6, Descuento = 0, ValorDescuento = 0, Total = 9000 });

            modelBuilder.Entity<Salida>().HasData(new Salida { Id = 18, FechaFactura = fechaAleatoria, IdCliente = 8, CantidadProductos = 1, TotalPagarConDescuento = 3900000, TotalPagarSinDescuento = 3900000, TotalDescuento = 0 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 32, IdSalida = 18, IdCategoria = 21, IdProducto = 78, IdEntrada = 27, Precio = 130000, Cantidad = 30, Descuento = 0, ValorDescuento = 0, Total = 3900000 });

            modelBuilder.Entity<Salida>().HasData(new Salida { Id = 19, FechaFactura = fechaAleatoria, IdCliente = 3, CantidadProductos = 1, TotalPagarConDescuento = 3900000, TotalPagarSinDescuento = 3900000, TotalDescuento = 0 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 33, IdSalida = 19, IdCategoria = 21, IdProducto = 78, IdEntrada = 27, Precio = 130000, Cantidad = 30, Descuento = 0, ValorDescuento = 0, Total = 3900000 });

            modelBuilder.Entity<Salida>().HasData(new Salida { Id = 20, FechaFactura = fechaAleatoria, IdCliente = 10, CantidadProductos = 6, TotalPagarConDescuento = 46052000, TotalPagarSinDescuento = 46052000, TotalDescuento = 0 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 34, IdSalida = 20, IdCategoria = 24, IdProducto = 84, IdEntrada = 30, Precio = 400000, Cantidad = 3, Descuento = 0, ValorDescuento = 0, Total = 1200000 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 35, IdSalida = 20, IdCategoria = 25, IdProducto = 87, IdEntrada = 31, Precio = 2800000, Cantidad = 6, Descuento = 0, ValorDescuento = 0, Total = 16800000 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 36, IdSalida = 20, IdCategoria = 25, IdProducto = 88, IdEntrada = 32, Precio = 2900000, Cantidad = 2, Descuento = 0, ValorDescuento = 0, Total = 5800000 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 37, IdSalida = 20, IdCategoria = 25, IdProducto = 89, IdEntrada = 33, Precio = 1400000, Cantidad = 5, Descuento = 0, ValorDescuento = 0, Total = 7000000 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 38, IdSalida = 20, IdCategoria = 25, IdProducto = 85, IdEntrada = 34, Precio = 3800000, Cantidad = 4, Descuento = 0, ValorDescuento = 0, Total = 15200000 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 39, IdSalida = 20, IdCategoria = 11, IdProducto = 29, IdEntrada = 5, Precio = 2600, Cantidad = 20, Descuento = 0, ValorDescuento = 0, Total = 52000 });

            modelBuilder.Entity<Salida>().HasData(new Salida { Id = 21, FechaFactura = fechaAleatoria, IdCliente = 10, CantidadProductos = 1, TotalPagarConDescuento = 4500, TotalPagarSinDescuento = 4500, TotalDescuento = 0 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 40, IdSalida = 21, IdCategoria = 6, IdProducto = 11, IdEntrada = 1, Precio = 1500, Cantidad = 3, Descuento = 0, ValorDescuento = 0, Total = 4500 });

            modelBuilder.Entity<Salida>().HasData(new Salida { Id = 22, FechaFactura = fechaAleatoria, IdCliente = 5, CantidadProductos = 2, TotalPagarConDescuento = 1424970, TotalPagarSinDescuento = 1499968, TotalDescuento = 74998 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 41, IdSalida = 22, IdCategoria = 15, IdProducto = 44, IdEntrada = 12, Precio = 10000, Cantidad = 38, Descuento = 5, ValorDescuento = 19000, Total = 361000 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 42, IdSalida = 22, IdCategoria = 16, IdProducto = 47, IdEntrada = 13, Precio = 34999, Cantidad = 32, Descuento = 5, ValorDescuento = 55998, Total = 1063970 });

            modelBuilder.Entity<Salida>().HasData(new Salida { Id = 23, FechaFactura = fechaAleatoria, IdCliente = 16, CantidadProductos = 2, TotalPagarConDescuento = 32400000, TotalPagarSinDescuento = 32400000, TotalDescuento = 0 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 43, IdSalida = 23, IdCategoria = 24, IdProducto = 84, IdEntrada = 30, Precio = 400000, Cantidad = 25, Descuento = 0, ValorDescuento = 0, Total = 10000000 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 44, IdSalida = 23, IdCategoria = 25, IdProducto = 87, IdEntrada = 31, Precio = 2800000, Cantidad = 8, Descuento = 0, ValorDescuento = 0, Total = 22400000 });

            modelBuilder.Entity<Salida>().HasData(new Salida { Id = 24, FechaFactura = fechaAleatoria, IdCliente = 3, CantidadProductos = 1, TotalPagarConDescuento = 9000, TotalPagarSinDescuento = 9000, TotalDescuento = 0 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 45, IdSalida = 24, IdCategoria = 6, IdProducto = 11, IdEntrada = 1, Precio = 1500, Cantidad = 6, Descuento = 0, ValorDescuento = 0, Total = 9000 });

            modelBuilder.Entity<Salida>().HasData(new Salida { Id = 25, FechaFactura = fechaAleatoria, IdCliente = 12, CantidadProductos = 2, TotalPagarConDescuento = 32400000, TotalPagarSinDescuento = 32400000, TotalDescuento = 0 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 46, IdSalida = 25, IdCategoria = 24, IdProducto = 84, IdEntrada = 30, Precio = 400000, Cantidad = 25, Descuento = 0, ValorDescuento = 0, Total = 10000000 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 47, IdSalida = 25, IdCategoria = 25, IdProducto = 87, IdEntrada = 31, Precio = 2800000, Cantidad = 8, Descuento = 0, ValorDescuento = 0, Total = 22400000 });

            modelBuilder.Entity<Salida>().HasData(new Salida { Id = 26, FechaFactura = fechaAleatoria, IdCliente = 11, CantidadProductos = 1, TotalPagarConDescuento = 14000000, TotalPagarSinDescuento = 14000000, TotalDescuento = 0 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 48, IdSalida = 26, IdCategoria = 25, IdProducto = 89, IdEntrada = 33, Precio = 1400000, Cantidad = 10, Descuento = 0, ValorDescuento = 0, Total = 14000000 });

            modelBuilder.Entity<Salida>().HasData(new Salida { Id = 27, FechaFactura = fechaAleatoria, IdCliente = 13, CantidadProductos = 2, TotalPagarConDescuento = 125900000, TotalPagarSinDescuento = 125900000, TotalDescuento = 0 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 49, IdSalida = 27, IdCategoria = 16, IdProducto = 53, IdEntrada = 17, Precio = 1900000, Cantidad = 43, Descuento = 0, ValorDescuento = 0, Total = 81700000 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 50, IdSalida = 27, IdCategoria = 21, IdProducto = 75, IdEntrada = 25, Precio = 1700000, Cantidad = 26, Descuento = 0, ValorDescuento = 0, Total = 44200000 });

            modelBuilder.Entity<Salida>().HasData(new Salida { Id = 28, FechaFactura = fechaAleatoria, IdCliente = 9, CantidadProductos = 1, TotalPagarConDescuento = 24225000, TotalPagarSinDescuento = 25500000, TotalDescuento = 1275000 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 51, IdSalida = 28, IdCategoria = 21, IdProducto = 75, IdEntrada = 25, Precio = 1700000, Cantidad = 15, Descuento = 5, ValorDescuento = 1275000, Total = 24225000 });

            modelBuilder.Entity<Salida>().HasData(new Salida { Id = 29, FechaFactura = fechaAleatoria, IdCliente = 14, CantidadProductos = 2, TotalPagarConDescuento = 97700000, TotalPagarSinDescuento = 97700000, TotalDescuento = 0 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 52, IdSalida = 29, IdCategoria = 16, IdProducto = 53, IdEntrada = 17, Precio = 1900000, Cantidad = 21, Descuento = 0, ValorDescuento = 0, Total = 39900000 });
            modelBuilder.Entity<ProductoSalida>().HasData(new ProductoSalida { Id = 53, IdSalida = 29, IdCategoria = 21, IdProducto = 75, IdEntrada = 25, Precio = 1700000, Cantidad = 34, Descuento = 0, ValorDescuento = 0, Total = 57800000 });
